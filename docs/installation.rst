...
To install pysteps-importer-msg-roa, run this command in your terminal:

.. code-block:: console

    $ pip install pysteps-importer-msg-roa
...
The latest development version of pysteps-importer-msg-roa can be installed using
pip by running in a terminal::

    pip install git+https://github.com/YOUR_GITHUB_USERNAME/pysteps-importer-msg-roa

Or, from a local copy of the repo::

    git clone https://github.com/YOUR_GITHUB_USERNAME/pysteps-importer-msg-roa
    cd pysteps-importer-msg-roa
    pip install .
